Items = [
    {
        ...
        "gifDemoUrl": "http://gifmaker.develophelper.com/demo/gif/1.gif",
        "gifType": 1,
        "name": "sorry为所欲为（来源：TVB电视剧《读心神探》）",
        "thumbnail": "http://gifmaker.develophelper.com/demo/thumbnail/1.jpg"
    },
    {
        "tplid": 2,
        "contents": "我就是饿死##$@?$?@$##死外边 从这跳下去##$@?$?@$##也不会吃你们一点东西##$@?$?@$##真香",
        "gifDemoUrl": "http://gifmaker.develophelper.com/demo/gif/2.gif",
        "gifType": 2,
        "name": "我就是饿死（来源：《变形记》第八季之《远山的抉择》）",
        "thumbnail": "http://gifmaker.develophelper.com/demo/thumbnail/2.jpg"
    },
    {
        "tplid": 3,
        "contents": "没有钱啊 肯定要做的啊##$@?$?@$##不做的话没有钱用##$@?$?@$##那你不会去打工啊##$@?$?@$##有手有脚的##$@?$?@$##打工是不可能打工的##$@?$?@$##这辈子不可能打工的",
        "gifDemoUrl": "http://gifmaker.develophelper.com/demo/gif/3.gif",
        "gifType": 3,
